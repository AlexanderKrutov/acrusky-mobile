...
/**
 * Contains math routines don't included in standard J2ME package
 * @author krutov
 */
public class Math2
{
  ...
  static public double hsin(double x)
  {
      return (exp(x)-exp(-x))/2.0;
  }
  
  static public double hcos(double x)
  {
      return (exp(x)+exp(-x))/2.0;
  }

  static public double htan(double x)
  {
      return hsin(x)/hcos(x);
  }  
 
  static public double hasin(double x)
  {
      return log(x+Math.sqrt(x*x+1));
  }  
  static public double hacos(double x)
  {
      return log(x+Math.sqrt(x*x-1));
  }
  
  static public double hatan(double x)
  {
